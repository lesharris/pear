...
export const docsMeta = {
  title: 'Buttons | Pear',
  description: 'Button variants, grouped actions, disabled states, and loading examples for Pear.',
  tocItems: [
...
const buttonProps: DocsApiItem[] = [
  {
    ...
    default: "'button'",
    description: 'Renders a native button, submit input, or reset input.',
  },
  {
    name: 'variant',
    type: "'secondary' | 'contrast'",
    description: "Applies Pico's secondary or contrast button variant.",
  },
  {
    name: 'outline',
    type: 'boolean',
    default: 'false',
    description: "Applies Pico's outline button style.",
  },
  { name: 'disabled', type: 'boolean', default: 'false', description: 'Disables the control.' },
  {
    ...
    type: 'boolean',
    default: 'false',
    description: 'Disables the control and sets aria-busy.',
  },
  {
    name: 'value',
    type: 'string',
    description: 'Label value for submit and reset input render modes.',
  },
...
const buttonSlots: DocsApiItem[] = [
  {
    name: 'default',
    type: 'slot',
    description: 'Button content when rendering the default button mode.',
  },
]
...
const buttonEvents: DocsApiItem[] = [
  {
    name: 'native events',
    type: 'MouseEvent, FocusEvent, ...',
    description: 'Native button/input events pass through Vue fallthrough attributes.',
  },
]
</script>
...
<template>
  <section id="overview" data-section class="docs-section">
    <DocsIntroCard name="PButton">
      <code>PButton</code> is the everyday button wrapper. It keeps Pico's button styles and adds a
      few Vue niceties: variants, loading state, submit/reset modes, and tooltips.
    </DocsIntroCard>
  </section>
    ...
    <p-card>
      ...
      <DocsExample :code="tooltipCode" preview-overflow="visible">
        <AppCluster>
          ...
          <p-button variant="secondary" tooltip="Nothing to undo yet" disabled> Undo </p-button>
        </AppCluster>
      </DocsExample>
    </p-card>
  </section>
