...
const props: DocsApiItem[] = [
  ...
  { name: "error", type: "string", description: "Validation message. Also marks the group invalid." },
  { name: "disabled", type: "boolean", default: "false", description: "Disables the fieldset and nested controls." },
  { name: "invalid", type: "boolean", default: "false", description: "Marks nested Pear controls invalid." },
...
<template>
  <section id="overview" data-section class="docs-section">
    <DocsIntroCard name="PFieldset">
      <code>PFieldset</code> is for grouped controls. It keeps the
      <code>fieldset</code> and <code>legend</code> semantics while sharing
      disabled, invalid, and described-by state with Pear controls.
    </DocsIntroCard>
  </section>
