...
export const docsMeta = {
  ...
  description: 'Date and time input examples using Pear form components and PicoCSS styling.',
  tocItems: [
...
const dateInputProps: DocsApiItem[] = [
  { name: 'v-model', type: 'string', description: 'Native date/time input value.' },
  {
    ...
    description: 'Date/time input types supported by PInput.',
  },
  {
    name: 'disabled',
    type: 'boolean',
...
<template>
  <section id="overview" data-section class="docs-section">
    <DocsIntroCard name="PInput">
      <code>PInput</code> also covers date and time fields. The browser keeps its native picker, and
      Vue gets a plain string <code>v-model</code>.
    </DocsIntroCard>
  </section>
