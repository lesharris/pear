...
export const docsMeta = {
  title: 'Progress | Pear',
  description: 'Determinate and indeterminate progress indicators using Pear and PicoCSS.',
  tocItems: [
...
const progressProps: DocsApiItem[] = [
  {
    name: 'value',
    type: 'number',
    description: 'Current progress value. Omitted when indeterminate is true.',
  },
  { name: 'max', type: 'number', default: '100', description: 'Maximum progress value.' },
  {
    ...
    type: 'boolean',
    default: 'false',
    description: 'Renders an indeterminate progress indicator.',
  },
...
<template>
  <section id="overview" data-section class="docs-section">
    <DocsIntroCard name="PProgress">
      <code>PProgress</code> is a small native progress helper for known progress and "still
