...
const dropdownProps: DocsApiItem[] = [
  {
    name: 'summary',
    type: 'string',
    description: 'Text shown in the summary when no summary slot is provided.',
  },
  {
    name: 'open',
    type: 'boolean',
    default: 'false',
    description: 'Native details open state. Can be controlled with v-model:open.',
  },
  {
    name: 'button',
    type: 'boolean',
    default: 'false',
    description: "Applies Pico's button dropdown summary pattern.",
  },
  {
    name: 'variant',
  ...
  },
  {
    ...
    type: 'boolean',
    default: 'false',
    description: 'Sets aria-invalid on the summary.',
  },
  {
    name: 'align',
    type: "'start' | 'end'",
    description: 'Aligns the dropdown list. End alignment sets the list direction to rtl.',
  },
...
const dropdownSlots: DocsApiItem[] = [
  { name: 'summary', type: 'slot', description: 'Custom summary content.' },
  {
    name: 'default',
    type: 'slot',
    description: 'List item content rendered inside the dropdown menu ul.',
  },
]
...
<template>
  <section id="overview" data-section class="docs-section">
    <DocsIntroCard name="PDropdown">
      <code>PDropdown</code> is a native <code>details</code> dropdown for little menus: actions,
      quick links, and “more” buttons. For form choices, use <code>PSelect</code>,
      <code>PCheckbox</code>, or <code>PRadio</code>.
    </DocsIntroCard>
  </section>
      ...
      <AppStack>
        <DocsExample :code="stateAlignmentCode" preview-overflow="visible">
          <AppCluster>
            ...
            <p-button variant="secondary" @click="menuOpen = !menuOpen"> Toggle menu </p-button>
